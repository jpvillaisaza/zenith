...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ao: 'hidden', al: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ao: 'mozHidden', al: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ao: 'msHidden', al: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ao: 'webkitHidden', al: 'webkitvisibilitychange' }
		: { ao: 'hidden', al: 'visibilitychange' };
}
...
var $author$project$Main$Input4 = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$clean = function () {
	var p = F3(
		function (n, acc, xs) {
			p:
			while (true) {
				var _v0 = _Utils_Tuple2(n, xs);
				if (!_v0.b.b) {
					if (!_v0.a) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var dirty = msg.a;
				var m = $author$project$Main$clean(dirty);
				return $author$project$Main$Input4(m);
		}
	});
...
var $author$project$Main$Update4 = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Main$kplToL100 = function (n) {
	return 100 / n;
};
var $author$project$Main$l100ToKpl = function (n) {
	return 100 / n;
};
var $author$project$Main$l100ToMpg = function (n) {
	return 235.215 / n;
};
...
var $author$project$Main$milesToKilometers = function (n) {
	return n * 1.609;
};
				...
				[
					...
					_List_fromArray(
						[
							...
							A2($elm$html$Html$Attributes$style, 'min-width', '128px'),
...
var $author$project$Main$view = function (model) {
	var _v0 = function () {
		switch (model.$) {
				...
				return _Utils_Tuple2(
					...
					_Utils_Tuple3(
						...
						A2(
							...
							A2(
								$elm$core$Maybe$map,
								A2($elm$core$Basics$composeL, $author$project$Main$truncate, $author$project$Main$l100ToKpl),
								v))));
			case 1:
				var i2 = model.a;
			...
			default:
				var i4 = model.a;
				var v = $elm$core$String$toFloat(i4);
				return _Utils_Tuple2(
					A2(
						$elm$core$Maybe$withDefault,
						'',
						A2(
							$elm$core$Maybe$map,
							A2($elm$core$Basics$composeL, $author$project$Main$truncate, $author$project$Main$kplToL100),
							v)),
					_Utils_Tuple3(
						A2(
							$elm$core$Maybe$withDefault,
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'min-width', '128px'),
						A2($elm$html$Html$Attributes$style, 'max-width', '256px')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Units of fuel per fixed distance')
							])),
						A5(
						$author$project$Main$viewI,
						'fuel-consumption',
						true,
						_List_fromArray(
							[
								$elm$html$Html$text('L/100 km')
							]),
						$author$project$Main$Update1,
						input1)
					])),
				A2(
				$elm$html$Html$fieldset,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Units of distance per fixed fuel unit')
							])),
						A5(
						$author$project$Main$viewI,
						'fuel-economy-mpg',
						...
						_List_fromArray(
							[
								$elm$html$Html$text('km/L')
							]),
						$author$project$Main$Update4,
						input4)
					]))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{aq: $author$project$Main$init, ay: $author$project$Main$update, az: $author$project$Main$view});
